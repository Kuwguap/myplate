...
export class TelegramController {
    static async handleWebhook(req, res, next) {
        try {
            ...
            if (message.text === '/start') {
                ...
                await sendTelegramMessage(chatId, 'Welcome! 👋 I can help you create vehicle transfer documents.\n\n' +
            ...
            try {
                ...
                if (missingFields.length > 0) {
                    ...
                    await sendTelegramMessage(chatId, '❌ Error: Missing required fields:\n' +
                ...
                if (formData.vin.length !== 17) {
                    ...
                    await sendTelegramMessage(chatId, '❌ Error: Invalid VIN number.\n' +
                ...
                await db.run('INSERT INTO temp_form_data (chat_id, form_data) VALUES (?, ?)', [chatId, JSON.stringify(pdfFormData)]);
                // Send confirmation message with the data summary
                const frontendUrl = process.env.FRONTEND_URL || 'http://localhost:3000';
                await sendTelegramMessage(chatId, '✅ Form data received successfully!\n\n' +
                ...
                await sendTelegramMessage(chatId, '❌ Error: Invalid JSON format.\n\n' +
    ...
    static async getLatestFormData(req, res, next) {
        try {
            ...
            const formData = await db.get('SELECT form_data FROM temp_form_data WHERE chat_id = ? ORDER BY created_at DESC LIMIT 1', [chat_id]);
            if (!formData) {
